...
# with independence assumption i.e. P(C1/C0) = P(C1); must use compute_subspace_probabilities_independent
...
# without independence assumption i.e. P(C1/C0) != P(C1); uses compute_subspace_probabilities
